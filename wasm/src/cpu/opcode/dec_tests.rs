...
fn op_dec_rr() {
    ...
    for i in [0b00, 0b01, 0b10, 0b11].iter() {
        ...
        assert_eq!(cpu.registers.pc, pc + 1);
        match i {
            0b00 => assert_eq!(cpu.registers.bc_get(), v.wrapping_sub(1)),
            0b01 => assert_eq!(cpu.registers.de_get(), v.wrapping_sub(1)),
            0b10 => assert_eq!(cpu.registers.hl_get(), v.wrapping_sub(1)),
            0b11 => assert_eq!(cpu.registers.sp, v.wrapping_sub(1)),
            _ => panic!("never reach"),
        }
    }
}
