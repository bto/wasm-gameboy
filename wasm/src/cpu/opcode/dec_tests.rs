...
fn op_dec_r() {
    ...
    for i in [0b000, 0b001, 0b010, 0b011, 0b100, 0b101, 0b111].iter() {
        ...
        match i {
            0b000 => cpu.registers.b = 0b1_0000,
            0b001 => cpu.registers.c = 0b1_0000,
            0b010 => cpu.registers.d = 0b1_0000,
            0b011 => cpu.registers.e = 0b1_0000,
            0b100 => cpu.registers.h = 0b1_0000,
            0b101 => cpu.registers.l = 0b1_0000,
            0b111 => cpu.registers.a = 0b1_0000,
            _ => panic!("never reach"),
        }
        ...
        match i {
            0b000 => assert_eq!(cpu.registers.b, 0b0_1111),
            0b001 => assert_eq!(cpu.registers.c, 0b0_1111),
            0b010 => assert_eq!(cpu.registers.d, 0b0_1111),
            0b011 => assert_eq!(cpu.registers.e, 0b0_1111),
            0b100 => assert_eq!(cpu.registers.h, 0b0_1111),
            0b101 => assert_eq!(cpu.registers.l, 0b0_1111),
            0b111 => assert_eq!(cpu.registers.a, 0b0_1111),
            _ => panic!("never reach"),
        }
...
fn op_dec_rrn() {
    ...
    cpu.registers.h = 1;
    cpu.registers.l = 2;
    cpu.mmu.byte_set(0x102, 0b1_0000);
    cpu.registers.carry = true;
    cpu.registers.half_carry = false;
    cpu.registers.subtraction = false;
    cpu.registers.zero = true;
    ...
    assert_eq!(cpu.registers.subtraction, true);
    assert_eq!(cpu.registers.zero, false);
    assert_eq!(cpu.mmu.byte_get(0x102), 0b0_1111);
