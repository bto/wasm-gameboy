...
fn op_set_r() {
    ...
    for b in [0b000, 0b001, 0b010, 0b011, 0b100, 0b101, 0b110, 0b111].iter() {
        for i in [0b000, 0b001, 0b010, 0b011, 0b100, 0b101, 0b111].iter() {
            ...
            match i {
                0b000 => assert_eq!(cpu.registers.b, 0b1111_1111),
                0b001 => assert_eq!(cpu.registers.c, 0b1111_1111),
                0b010 => assert_eq!(cpu.registers.d, 0b1111_1111),
                0b011 => assert_eq!(cpu.registers.e, 0b1111_1111),
                0b100 => assert_eq!(cpu.registers.h, 0b1111_1111),
                0b101 => assert_eq!(cpu.registers.l, 0b1111_1111),
                0b111 => assert_eq!(cpu.registers.a, 0b1111_1111),
                _ => panic!("never reach"),
            }
        }
    }
...
fn op_set_rrn() {
    ...
    for b in [0b000, 0b001, 0b010, 0b011, 0b100, 0b101, 0b110, 0b111].iter() {
        ...
        assert_eq!(cpu.registers.zero, false);
        match b {
            0b000 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0000_0001),
            0b001 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0000_0010),
            0b010 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0000_0100),
            0b011 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0000_1000),
            0b100 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0001_0000),
            0b101 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0010_0000),
            0b110 => assert_eq!(cpu.mmu.byte_get(0x302), 0b0100_0000),
            0b111 => assert_eq!(cpu.mmu.byte_get(0x302), 0b1000_0000),
            _ => panic!("never reach"),
        }
        ...
        assert_eq!(cpu.registers.subtraction, true);
        assert_eq!(cpu.registers.zero, true);
        assert_eq!(cpu.mmu.byte_get(0x403), 0b1111_1111);
    }
}
